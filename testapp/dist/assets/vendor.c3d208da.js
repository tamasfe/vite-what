...
const GLOBALS_WHITE_LISTED$1 = "Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt";
...
const toDisplayString$1 = (val) => {
  return val == null ? "" : isObject$1(val) ? JSON.stringify(val, replacer$1, 2) : String(val);
};
...
function effect$1(fn, options = EMPTY_OBJ$1) {
  ...
  const effect2 = createReactiveEffect$1(fn, options);
  if (!options.lazy) {
    effect2();
  }
  return effect2;
}
function stop$1(effect2) {
  if (effect2.active) {
    cleanup$1(effect2);
...
function createReactiveEffect$1(fn, options) {
  const effect2 = function reactiveEffect() {
    ...
    if (!effectStack$1.includes(effect2)) {
      cleanup$1(effect2);
      try {
        enableTracking$1();
        effectStack$1.push(effect2);
        activeEffect$1 = effect2;
        return fn();
      } finally {
        effectStack$1.pop();
        resetTracking$1();
...
function track$1(target, type, key) {
  if (!shouldTrack$1 || activeEffect$1 === void 0) {
    return;
  }
...
function size(target, isReadonly2 = false) {
  target = target["__v_raw"];
  !isReadonly2 && track$1(toRaw$1(target), "iterate", ITERATE_KEY);
...
class RefImpl {
  ...
  get value() {
    track$1(toRaw$1(this), "get", "value");
    return this._value;
  }
  set value(newVal) {
    if (hasChanged$1(toRaw$1(newVal), this._rawValue)) {
      this._rawValue = newVal;
      this._value = this._shallow ? newVal : convert(newVal);
      trigger(toRaw$1(this), "set", "value", newVal);
    }
  }
}
  ...
  constructor(getter, _setter, isReadonly2) {
    ...
    this.effect = effect$1(getter, {
      ...
      scheduler: () => {
        if (!this._dirty) {
          this._dirty = true;
          trigger(toRaw$1(this), "set", "value");
        }
      }
    });
...
function findInsertionIndex$1(job) {
...
function queueJob$1(job) {
  if ((!queue$1.length || !queue$1.includes(job, isFlushing$1 && job.allowRecurse ? flushIndex$1 + 1 : flushIndex$1)) && job !== currentPreFlushParentJob$1) {
    const pos = findInsertionIndex$1(job);
    if (pos > -1) {
      queue$1.splice(pos, 0, job);
    } else {
      queue$1.push(job);
    }
    queueFlush$1();
...
function renderComponentRoot(instance) {
  ...
  try {
    ...
    result = createVNode$1(Comment$1$1);
  }
...
function filterSingleRoot(children) {
  ...
  for (let i = 0; i < children.length; i++) {
    ...
    if (isVNode$1(child)) {
      if (child.type !== Comment$1$1 || child.children === "v-if") {
        if (singleRoot) {
          return;
        } else {
          singleRoot = child;
  ...
  if (isRef$1(source)) {
    ...
    if (cb) {
      ...
      getter = () => {
        ...
        return callWithAsyncErrorHandling$1(source, instance, 3, [onInvalidate]);
      };
    }
  } else {
    getter = NOOP$1;
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const mountComponent = (initialVNode, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
    ...
    if (instance.asyncDep) {
      ...
      if (!initialVNode.el) {
        const placeholder = instance.subTree = createVNode$1(Comment$1$1);
  ...
  const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
    instance.update = effect$1(function componentEffect() {
...
const Comment$1$1 = Symbol(void 0);
...
function createBlock$1(type, props, children, patchFlag, dynamicProps) {
  const vnode = createVNode$1(type, props, children, patchFlag, dynamicProps, true);
...
const normalizeRef$1 = ({ ref: ref2 }) => {
  return ref2 != null ? isString$1(ref2) || isRef$1(ref2) || isFunction$1(ref2) ? { i: currentRenderingInstance$1, r: ref2 } : ref2 : null;
};
const createVNode$1 = _createVNode$1;
function _createVNode$1(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  if (isBlockTreeEnabled > 0 && !isBlockNode && currentBlock$1 && (patchFlag > 0 || shapeFlag & 6) && patchFlag !== 32) {
    currentBlock$1.push(vnode);
  }
  return vnode;
}
function cloneVNode$1(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    ref: extraProps && extraProps.ref ? mergeRef && ref2 ? isArray$1(ref2) ? ref2.concat(normalizeRef$1(extraProps)) : [ref2, normalizeRef$1(extraProps)] : normalizeRef$1(extraProps) : ref2,
...
function normalizeVNode(child) {
  if (child == null || typeof child === "boolean") {
    return createVNode$1(Comment$1$1);
  } else if (isArray$1(child)) {
    return createVNode$1(Fragment$1, null, child.slice());
...
function renderList$1(source, renderItem) {
  let ret;
...
const PublicInstanceProxyHandlers$1 = {
  ...
  has({ _: { data, setupState, accessCache, ctx, appContext, propsOptions } }, key) {
    let normalizedProps;
    return accessCache[key] !== void 0 || data !== EMPTY_OBJ$1 && hasOwn$1(data, key) || setupState !== EMPTY_OBJ$1 && hasOwn$1(setupState, key) || (normalizedProps = propsOptions[0]) && hasOwn$1(normalizedProps, key) || hasOwn$1(ctx, key) || hasOwn$1(publicPropertiesMap$1, key) || hasOwn$1(appContext.config.globalProperties, key);
  }
};
const RuntimeCompiledPublicInstanceProxyHandlers = extend$1({}, PublicInstanceProxyHandlers$1, {
  get(target, key) {
  ...
  has(_, key) {
    const has2 = key[0] !== "_" && !isGloballyWhitelisted$1(key);
    return has2;
  }
});
...
function recordInstanceBoundEffect$1(effect2, instance = currentInstance$1) {
  if (instance) {
...
function computed(getterOrOptions) {
  ...
  recordInstanceBoundEffect$1(c.effect);
  return c;
}
const version = "3.1.4";
...
export { Fragment as F, createVNode as a, createCommentVNode as b, createBlock as c, defineComponent as d, createTextVNode as e, defineComponent$1 as f, openBlock$1 as g, createBlock$1 as h, Fragment$1 as i, renderList$1 as j, createTextVNode$1 as k, toDisplayString$1 as l, ref as m, createVNode$1 as n, openBlock as o, createApp as p, renderList as r, toDisplayString as t, unref$1 as u };
